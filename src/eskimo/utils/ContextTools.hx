...
class ContextTools
{
	...
	{
		return new View(includes, excludes, context.entities);
	}
	...
	{
		return new EventView(includes, excludes, context.entities);
	}
	...
	{
		return new BufferView(includes, excludes, context.entities);
	}
